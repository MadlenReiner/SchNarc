...
class SHARC_NN(SHARC_INTERFACE):
    ...
    def do_qm_job(self, tasks, Crd):
        ...
        #print("here")
        Hamiltonian[0][0]=np.cdouble(0.5*k*(x-(x1_S))**2+E+1.0*y**2+1.0*z**2 + 0.0000j)
        Hamiltonian[1][1]=np.cdouble(0.5*k*(x-(x2_S))**2+E+1.0*y**2+1.0*z**2 + 0.0000j)
        Hamiltonian[1][0]=np.cdouble(n + 0.0000j)
        Hamiltonian[0][1]=np.cdouble(n + 0.0000j)
        #print("here2")
        ...
        SH2ANA["gvar"]=[["x","y","z"]]
        deriv={}
        deriv["x"]=[[np.cdouble(k*(x-(x1_S)) + 0.00j),np.cdouble(0.00 + 0.00j)],[np.cdouble(0.00 + 0.00j),np.cdouble(k*(x-(x2_S))+0.00j)]]
        deriv["y"]=[[np.cdouble(2*1.0*y + 0.0000j),np.cdouble(0.0000 + 0.0000j)],[np.cdouble(0.0000+0.0000j),np.cdouble(2*1.0*y+0.0000j)]]
        deriv["z"]=[[np.cdouble(2*1.0*z + 0.0000j),np.cdouble(0.0000 + 0.0000j)],[np.cdouble(0.0000+0.0000j),np.cdouble(2*1.0*z+0.0000j)]]
